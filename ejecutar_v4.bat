...
cd /d "%~dp0"
echo ============================================
echo   Modelo v4 - k zonas con reglas de convivencia
...
echo [4/4] Comparando solvers v4 (prioridad baja, ~8 min)...
start "" /low /wait /b "%VPY%" banco_pruebas\comparar_v4.py %*
if errorlevel 1 (echo [ERROR] La ejecucion fallo.) else (echo [OK] Ejecucion completada.)
pause
endlocal
